...
import com.gitan.mystoryapp.DataDummy
import com.gitan.mystoryapp.MainDispatcherRule
import com.gitan.mystoryapp.data.StoryRepository
import com.gitan.mystoryapp.data.response.ListStoryItem
import com.gitan.mystoryapp.getOrAwatValue
...
class MainViewModelTest{
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        val actualStory: PagingData<ListStoryItem> = mainViewModel.stories.getOrAwatValue()
